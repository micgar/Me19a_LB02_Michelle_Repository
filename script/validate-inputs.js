...
function validateForm() {
    if (!checkRequired([email, firstName, surname, canton, country, date, feedback, postalcode])) {
        checkLength(firstName, 3, 20);
        checkLength(surname, 3, 20);
        checkLength(date, 9, 10);
        checkLength(canton, 3, 20);
        checkLength(country, 3, 30);
        checkLength(feedback, 3, 80);
        checkLength(postalcode, 3, 4);
        checkEmail(email);
    }
}
